...
name: security
description: >-
  Performs deep security audits (ASVS-style depth, supply chain, crypto, compliance mindset). Use before external deploys, after auth or payments changes, when handling sensitive data, or for dedicated security review.
---

# /security — Auditoria de Seguranca (v2.1)
