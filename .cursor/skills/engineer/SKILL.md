...
name: engineer
description: >-
  Audits code for security-first OWASP coverage, architecture, performance, cost, resilience, and production quality. Use when reviewing code, validating implementations, or requesting a deep engineering audit.
---

# /engineer — Validacao de Codigo (v2)
...
> Para auditoria de seguranca completa (OWASP ASVS, supply chain, LLM, multi-tenant, file upload), use `/security`.
...
- **Para deep security audit, usar `/security`.**
