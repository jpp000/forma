...
name: init
description: >-
  Guides new greenfield setup with security-first foundations, stack evaluation, structure, and production-minded defaults. Use when starting a new project, choosing a stack, or scaffolding from zero.
---

# /init — Inicio de Projeto (v2)
...
*Hiring pool e baixo em stacks muito opinativas. Mas conta se vai escalar time.
...
- **Apos o init, rodar `/security` L1 pra validar que a fundacao de seguranca esta solida**
