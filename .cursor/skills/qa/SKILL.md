...
name: qa
description: >-
  Runs broad QA — security checks, automated tests, edge cases, infra, agents, data integrity, and realistic usage. Use before ship, for regression confidence, or full verification passes.
---

# /qa — Quality Assurance (v2)
...
> Para scan completo com 20+ patterns (Stripe, Slack, SendGrid, DB URLs, etc.), usar `/security` Dominio 7.
...
- **Para deep security audit (OWASP ASVS, LLM, multi-tenant, file upload, business logic), usar `/security`.**
