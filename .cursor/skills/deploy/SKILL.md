...
name: deploy
description: >-
  Validates deploy and infra readiness — Docker, environments, migrations, health, reproducibility, and security gates. Use when checking production readiness, containers, or local-to-cloud parity.
---

# /deploy — Validacao de Deploy (v2)
...
**Checklist de ports (exemplos internos):**
| Projeto | API | Web | Postgres | Redis | Outros |
|---|---|---|---|---|---|
| platform-core | 8000 | 3000 | 5432 | 6379 | — |
| scout | 8001 | 3000 | 5433 | 6381 | — |
| finance | 8003 | 3001 | 5434 | — | — |
| orion-finance | 8005 | 3002 | 5436 | 6383 | MinIO 9000-9001 |
| product-lab | 8004 | — | 5435 | 6382 | — |
...
> Para auditoria de seguranca completa (OWASP ASVS, LLM, multi-tenant, business logic), usar `/security` apos o deploy estar funcional.
